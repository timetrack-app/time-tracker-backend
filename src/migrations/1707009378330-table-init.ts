...
export class TableInit1707009378330 implements MigrationInterface {
    name = 'TableInit1707009378330'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "work_sessions" ALTER COLUMN "isPaused" SET DEFAULT false`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "tasks" DROP CONSTRAINT "FK_f69dc09246817393a46eb2a47c5"`);
        await queryRunner.query(`ALTER TABLE "lists" DROP CONSTRAINT "FK_8763f67ca62a3d68345d6b41ec7"`);
        await queryRunner.query(`ALTER TABLE "work_sessions" ALTER COLUMN "isPaused" DROP DEFAULT`);
